...
final class AlertAnimationAttributesViewController: UIViewController {
    ...
    init(animationAttributes: AlertAnimationAttributes) {
...
extension AlertAnimationAttributesViewController: AlertAnimationAttributesViewDelegate {
    func alertAnimationAttributesView(_ alertAnimationAttributesView: AlertAnimationAttributesView, didTapAddAnimationButton button: UIButton, animation: AlertAnimationAttributes) {
        sceneEditorViewController().didTapAddAlertAnimationButton(button, animation: animation)
